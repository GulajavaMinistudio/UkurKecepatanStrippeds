 ...
 */
class FragTabKecepatanMPH : Fragment(), FragTabKecepatanContract.View {
    ...
    override fun onCreateView(
        ...
        mContext = this@FragTabKecepatanMPH.context
        mActivityParent = this@FragTabKecepatanMPH.activity
    ...
    override fun initDataAwal() {
        ...
        mFragTabKecepatanViewModel = ViewModelProviders.of(this@FragTabKecepatanMPH)
        ...
        mFragTabKecepatanViewModel?.setTipeBatasKecepatanFragment(Konstans.STR_MPH)
    }
    ...
    override fun initTampilan() {
        ...
        mTextViewSatuanKecepatan?.text = Konstans.STR_MPH
    ...
    override fun initViewModelObservers() {
        ...
        mFragTabKecepatanViewModel?.getLiveDataBarKecepatanItem()?.observe(this@FragTabKecepatanMPH,
            Observer { bartampilitems: BarKecepatanTampilItems? ->

                Log.w("KECEPATAN MPH","MPH")
        ...
        mFragTabKecepatanViewModel?.getLiveDataStateView()?.observe(this@FragTabKecepatanMPH,
    ...
    override fun stopViewModelObservers() {
        ...
        mFragTabKecepatanViewModel?.getLiveDataBarKecepatanItem()
            ?.removeObservers(this@FragTabKecepatanMPH)
        ...
        mCompositeDisposable.add(
            mPublishSubjectKecepatan
                ...
                .map { _: Boolean ->
                    ...
                    val stringKecepatanNilai: String = mKecepatanItems.mIntKecepatanMph.toString()
