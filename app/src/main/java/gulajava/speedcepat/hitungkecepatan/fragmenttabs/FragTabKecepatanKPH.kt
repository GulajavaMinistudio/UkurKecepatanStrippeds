 ...
 */
class FragTabKecepatanKPH : Fragment(), FragTabKecepatanContract.View {
    ...
    override fun onCreateView(
        ...
        mContext = this@FragTabKecepatanKPH.context
        mActivityParent = this@FragTabKecepatanKPH.activity
    ...
    override fun initDataAwal() {
        ...
        mFragTabKecepatanViewModel = ViewModelProviders.of(this@FragTabKecepatanKPH)
        ...
        mFragTabKecepatanViewModel?.setTipeBatasKecepatanFragment(Konstans.STR_KMH)
    }
    ...
    override fun initTampilan() {
        ...
        mTextViewSatuanKecepatan?.text = Konstans.STR_KMH
    ...
    override fun initViewModelObservers() {
        ...
        mFragTabKecepatanViewModel?.getLiveDataBarKecepatanItem()?.observe(this@FragTabKecepatanKPH,
        ...
        mFragTabKecepatanViewModel?.getLiveDataStateView()?.observe(this@FragTabKecepatanKPH,
    ...
    override fun stopViewModelObservers() {
        ...
        mFragTabKecepatanViewModel?.getLiveDataBarKecepatanItem()
            ?.removeObservers(this@FragTabKecepatanKPH)
        ...
        mCompositeDisposable.add(
            mPublishSubjectKecepatan
                ...
                .map { _: Boolean ->
                    ...
                    val stringKecepatanNilai: String = mKecepatanItems.mIntKecepatanKmh.toString()
